...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_ortho_4x12( \
        ...
        KC_LSFT,  KC_Z  ,  KC_X  ,  KC_C  ,   KC_V ,    KC_B,      KC_K   , KC_M   , KC_COMM, KC_DOT ,  KC_Q  , KC_BSLS, \
    ...
    [_NUMBERS] = LAYOUT_ortho_4x12( \
        ...
        KC_PGDN, KC_PGUP, S(KC_LBRC), S(KC_RBRC), KC_LBRC, KC_RBRC,      KC_DEL , KC_SYRQ, KC_HOME, KC_END , KC_GRV ,  KC_INS, \
          _x_  ,   _x_  , _______, _______, _______, _______,      _______, _______, _______,   _x_  ,   _x_  ,   _x_    \
    ),
    [_ARROWS] = LAYOUT_ortho_4x12( \
        KC_F1  ,  KC_F2 ,  KC_F3 ,  KC_F4 ,  KC_F5 ,   KC_F6,      KC_F7  ,  KC_F8 ,  KC_F9 , KC_F10 , KC_F11 ,  KC_F12, \
          _x_  ,   _x_  ,   BAR  ,  P_TAB ,  N_TAB ,   _x_  ,        _x_  , KC_DOWN,  KC_UP , KC_LEFT, KC_RGHT,   _x_  , \
          _x_  ,   _x_  , KC_MPRV, KC_MPLY, KC_MNXT,   _x_  ,        _x_  , QK_BOOT,   _x_  ,   _x_  ,   _x_  ,   _x_  , \
          _x_  ,   _x_  , _______, _______, _______, _______,      _______, _______, _______,   _x_  ,   _x_  ,   _x_    \
    ),
    [_MOUSE] = LAYOUT_ortho_4x12( \
          _x_  ,   _x_  ,   _x_  ,   _x_  ,   _x_  ,   _x_  ,        _x_  , KC_WH_L, KC_MS_U, KC_WH_R,   _x_  ,   _x_  , \
          _x_  ,  LT_A  , KC_ACL0, KC_ACL1, KC_ACL2,   _x_  ,      KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_U,   _x_  , \
          _x_  ,   _x_  ,   _x_  ,   _x_  ,   _x_  ,   _x_  ,        _x_  ,   _x_  ,   _x_  ,   _x_  ,   _x_  ,   _x_  , \
          _x_  ,   _x_  , _______, _______, _______, _______,      KC_BTN1, KC_BTN2,   _x_  ,   _x_  ,   _x_  ,   _x_    \
    ), 
};
