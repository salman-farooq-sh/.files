...
[0] = LAYOUT_ortho_4x12( \
    ...
    KC_TAB   , KC_Q     , KC_W     , KC_F     , KC_P     , KC_G     , KC_J     , KC_L     , KC_U     , KC_Y     , _x_      , KC_BSPC  , \
    KC_ESC   , ALT_A    , CTL_R    , SFT_S    , GUI_t    , KC_D     , KC_H     , GUI_N    , SFT_E    , CTL_I    , ALT_O    , KC_ENT   , \
    KC_QUOT  , LT2_Z    , KC_X     , KC_C     , KC_V     , LT1_B    , LT1_K    , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_SCLN    \
), 
[1] = LAYOUT_ortho_4x12( \
    KC_F1    , KC_F2    , KC_F3    , KC_F4    , KC_F5    , KC_F6    , KC_F7    , KC_F8    , KC_F9    , KC_F10   , KC_F11   , KC_F12   , \
    _x_      , KC_GRV   , KC_VOLD  , KC_VOLU  , KC_BRID  , KC_BRIU  , KC_F14   , P_TAB    , N_TAB    , KC_WFAV  , KC_LBRC  , KC_RBRC  , \
    _x_      , ___      , ___      , ___      , ___      , _x_      , KC_LEFT  , KC_DOWN  , KC_UP    , KC_RGHT  , _x_      , _x_      , \
    QK_BOOT  , KC_F15   , KC_F17   , KC_F16   , KC_F13   , _x_      , KC_PSCR  , KC_DEL   , KC_HOME  , KC_END   , KC_BSLS  , QK_BOOT    \
),
[2] = LAYOUT_ortho_4x12( \
